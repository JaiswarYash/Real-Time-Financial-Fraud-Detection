    ...
    try:
        ...
        for model_name, model in models.items():
            with mlflow.start_run(run_name=model_name):
                ...
                mlflow.log_metric("test_recall", report[model_name]['test_recall'])
                mlflow.log_metric("test_precision", report[model_name]['test_precision'])
                mlflow.log_metric("test_f1", report[model_name]['test_f1'])
